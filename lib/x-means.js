export default class XMeans {
    ...
    improveStructure(clusters, centers) {
        ...
        console.log('total improving: ', clusters.length, clusters);
        for (let indexCluster = 0; indexCluster < clusters.length; indexCluster++) {
            ...
            parentChildCenters.push(this.listMathAdditionNumber(centers[indexCluster], difference));
            console.log('centers[indexCluster] = ', centers[indexCluster], ' of ', indexCluster);
            console.log('parentChildCenters = ', parentChildCenters);

            console.log('kmeans to ', clusters[indexCluster], indexCluster);
            const result = this.kmeansCluster(parentChildCenters, clusters[indexCluster]);
            console.log('result of kmeans: ', result);
            ...
            if (parentChildCenters.length > 1) {
                ...
                console.log('decide wheter to split');
    ...
    updateClusters(centers, availableIndexes = null) {
        ...
        if (!availableIndexes) {
            ...
            console.log('bypass = ', availableIndexes);
        ...
        for (let i = 0; i < bypass.length; i++) {
            ...
            console.log('indexPint = ', indexPoint);
            let indexOptim = -1;
            let distOptim = 0;
